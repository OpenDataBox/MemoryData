...
def _compat_get_tied_weight_keys(module):
    tied_weight_keys = []
...
modeling_utils._get_tied_weight_keys = _compat_get_tied_weight_keys
    ...
    def _init_embedding_config(self) -> None:
        ...
        config_dict = {
            ...
            "model_init_params": {
                ...
                # "torch_dtype": "auto",
                # Avoid accelerate's auto device mapping path here because
                # NV-Embed-v2's remote model code is not compatible with the
                # transformers 5.x expectation that `all_tied_weights_keys`
                # behaves like a mapping during balanced memory inference.
                # **kwargs
            },
            "encode_params": {
