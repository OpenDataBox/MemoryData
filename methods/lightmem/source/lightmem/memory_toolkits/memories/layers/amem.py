...
class AMEMLayer(BaseMemoryLayer):
    ...
    def __init__(self, config: AMEMConfig) -> None:
        """Create an interface of A-MEM backed by the vendored upstream code."""
    ...
    def add_message(self, message: Dict[str, str], **kwargs) -> None:
        ...
        # Keep the message rendering aligned with the upstream A-MEM example flow.
            ...
            outputs.append(
                {
                    ...
                    # Preserve the retrieval display format expected by the vendored layer.
                    "used_content": '\n'.join(
