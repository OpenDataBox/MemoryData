...
class MemOSClient:
    ...
    def __init__(
        ...
        default_url = (
            os.getenv("MEMOS_GLOBAL_BASE_URL")
            if final_is_global and os.getenv("MEMOS_GLOBAL_BASE_URL")
            else os.getenv("MEMOS_DEFAULT_BASE_URL", "http://127.0.0.1:8000/api/openmem/v1")
        )
