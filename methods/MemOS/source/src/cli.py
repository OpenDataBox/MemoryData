...
def download_examples(dest: str) -> bool:
    ...
    """Download examples from a user-specified archive."""
    zip_url = os.getenv("MEMOS_EXAMPLES_ZIP_URL")
    if not zip_url:
        print("❌ Set MEMOS_EXAMPLES_ZIP_URL to an archive containing an examples/ directory.")
        return False
