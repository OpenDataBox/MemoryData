...
LETTA_DIR = os.environ.get("LETTA_DIR") or os.environ.get("LETTA_LETTA_DIR") or os.path.join(os.path.expanduser("~"), ".letta")
...
RETRIEVAL_QUERY_DEFAULT_PAGE_SIZE = int(os.environ.get("LETTA_RETRIEVAL_QUERY_DEFAULT_PAGE_SIZE", "10"))
