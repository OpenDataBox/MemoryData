...
class Dolphin21MistralWrapper(LLMChatCompletionWrapper):
    """Wrapper for a Dolphin-style Mistral instruction model.
    ...
    def chat_completion_to_prompt(self, messages, functions, function_documentation=None):
        """Example prompt layout for the Dolphin-style wrapper.
        ...
        Function support follows the same JSON-oriented pattern.
