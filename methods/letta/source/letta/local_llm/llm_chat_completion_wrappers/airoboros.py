...
class Airoboros21Wrapper(LLMChatCompletionWrapper):
    """Wrapper for an Airoboros-style instruction model.
    ...
    def chat_completion_to_prompt(self, messages, functions, function_documentation=None):
        """Example prompt layout for the Airoboros-style wrapper.

        A chat.
        USER: {prompt}
        ASSISTANT:

        Function support is expressed in the same JSON-oriented style.
