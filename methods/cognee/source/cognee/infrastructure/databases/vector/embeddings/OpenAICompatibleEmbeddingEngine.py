...
See the upstream LiteLLM incident notes and issue tracker for background.
"""
...
class OpenAICompatibleEmbeddingEngine(EmbeddingEngine):
    ...
    def __init__(
        ...
        # Keep parity with LiteLLMEmbeddingEngine so chunking code can safely
        # probe for a tokenizer and fall back to word-count heuristics when absent.
        self.tokenizer = None
