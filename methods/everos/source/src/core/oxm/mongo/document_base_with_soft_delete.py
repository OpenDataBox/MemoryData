...
class DocumentBaseWithSoftDelete(DocumentBase):
    ...
    Usage example:
        ...
        # Single soft delete
        doc = await MyDocument.find_one({"email": "sample-user"})
        ...
        doc = await MyDocument.hard_find_one({"email": "sample-user"})
    ...
    async def restore(self, session: Optional[AsyncClientSession] = None) -> None:
        ...
        Example:
            ...
            doc = await MyDocument.hard_find_one(
                {"email": "sample-user", "deleted_at": {"$ne": None}}
            )
    ...
    async def restore_many(
        ...
        **pymongo_kwargs: Any,
        ...
        Example:
            ...
            result = await User.restore_many({"email": "sample-user"})
    ...
    def hard_find_many(  # type: ignore
        ...
        **pymongo_kwargs: Any,
        ...
        Example:
            ...
            all_users = await User.hard_find_many({"email": "sample-user"}).to_list()
    ...
    def hard_find_one(  # type: ignore
        ...
        **pymongo_kwargs: Any,
        ...
        Example:
            ...
            user = await User.hard_find_one({"email": "sample-user"})
    ...
    def find_one(  # type: ignore
        ...
        **pymongo_kwargs: Any,
        ...
        Example:
            # Find undeleted user
            user = await User.find_one({"email": "sample-user"})
        """
        # Add deleted_at = None filter condition
        args = cls._add_class_id_filter(args, with_children) + ({"deleted_at": None},)
        return cls._find_one_query_class(document_model=cls).find_one(
